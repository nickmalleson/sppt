...
XXXX HERE - revise code below to work with the new 'all' list.

```{r map.globalS, fig.width=8, fig.height=6, eval=FALSE}
...
```{r map.globalS.fuzzy, fig.width=6, fig.height=5, eval=FALSE}
