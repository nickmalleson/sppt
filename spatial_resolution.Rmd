...
XXXX HERE THINK ABOUT BEST WAY TO ASSIGN SHORT CRIME TYPES. PROBABLY AT THE BEGINNING WHEN DATA REA READ IN - NEW COLUMN (to match MArtin's crime types)
for (type in crime.types) {
