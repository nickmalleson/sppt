...
do.plot <- function() {
  ...
  for (i in 1:length(all)) {
    ...
    # The point at which the elbox hits the y axis
    elbow.y <- FUNC.log(elbow)
    
    # Also plot the tangent at the elbow
    #XXXX
    ...
    # Add vertical and horizontal line at the elbow
...
_TODO add an elbow and tangent_
