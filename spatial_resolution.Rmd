...
# (for testing )
#msea(data1[["base"]], data1[["test"]], N=5, n.shifts=1, ignore.zeros = F, step=1, return.sobject=FALSE,return.grids=FALSE, 
...
```{r runMSEA-test, cache=TRUE, eval=FALSE}
p1 <- BNER[BNER$YEAR==2015,]
p2 <- BNER[BNER$YEAR==2016,]
...
```{r runMSEA-test-plot, fig.width=5, fig.height=11, eval=FALSE}
