...
for (a in all) {
  ...
  elbow  <- x[min(which(grads.log1 < 0.00001))]
  elbow2 <- x[min(which(grads.log1 < 0.0001))]
  elbow3 <- x[min(which(grads.log1 < 0.001))]
  elbow4 <- x[min(which(grads.log1 < 0.01))]
  ...
  abline(v=elbow,  col=1)
  abline(v=elbow2,  col=2)
  abline(v=elbow3,  col=3)
  abline(v=elbow4,  col=4)
