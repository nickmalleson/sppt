...
choro.legend("topright", sh=shading(
  classIntervals(last.result@data$abs.pct.diff, n = 8, style = 'kmeans')$brks, 
  cols=add.alpha(brewer.pal(9,'Reds'), (1/length(r$results))) ) 
)
