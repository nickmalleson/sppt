...
```{r sanity.check.bner.results, fig.width=5, fig.height=3 }
...
### Analysis of change-point using Bayesian Inference
...
Now use the script 'changepoint_mcmc.ipynb'  to look for the change point. _It doesn't work yet, will leave it for now_.
